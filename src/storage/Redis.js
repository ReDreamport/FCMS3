...
exports.aDispose = async function () {
    "use strict"
    exports.client && exports.client.quit()
    subscriberClient && await subscriberClient.unsubscribeAsync('MetaChange')
...
exports.aPublish = async function (channel, message) {
    exports.client && await exports.client.publishAsync(channel, message)
}